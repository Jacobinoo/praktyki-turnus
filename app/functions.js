...
export function newParticipantForm() {
  return `<div class="new-course-form-header">Dodawanie ucznia do turnusu<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
</svg></div>
<div class="new-course-form-content">
  <h3 class="new-course-form-content-section-title">Dane osobowe</h3>
  <div class="new-course-form-content-info-wrapper">
    <input type="text" placeholder="Imię i nazwisko" class="new-course-form-content-input" id="fullname">
    <input type="text" placeholder="Miejsce urodzenia (np. Kielce)" class="new-course-form-content-input" id="birthplace">
    <input type="text" placeholder="PESEL" class="new-course-form-content-input" id="pesel">
    <input type="text" placeholder="Pełny adres zamieszkania" class="new-course-form-content-input" id="address">
    <textarea placeholder="Przykład: ul. Mickiewicza 10/3. 28-200 Staszów"></textarea>
  </div>
  <h3 class="new-course-form-content-section-title">Termin realizacji</h3>
  <div class="new-course-form-content-date-wrapper">
    <label for="range-from">Data rozpoczęcia</label>
...
export function renderParticipantDetailsView() {
  ...
  <tbody>
    ...
    <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
      ...
      <td>1.</td>
      <td>Kosmetyka włosów do ubrań i szczotek wielofunkcyjncyh</td>
      <td>15 godzin</td>
      <td>5</td>
      <td><a href="https://www.mbludzm.pl/sw-jan-pawel-ii" class="download-certificate-btn" target="_blank">Pokaż</a></td>
    </tr>
